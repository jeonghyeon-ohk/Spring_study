...
class CommentRepositoryTest{
  ...
  void findByArticleId() {
    ...
    /* Case 4: 999번 게시글의 모든 댓글 조회 */
    {
      ...
      List<Comment> expected = Arrays.asList();
      // 4. 비교 및 검증
      assertEquals(expected.toString(),comments.toString(),"999번 글이 없음");
    }
  ...
  void findByNickname() {
    /* Case 1: "Park"의 모든 댓글 조회 */
    {
      ...
      List<Comment> expected = Arrays.asList(a,b,c);
      // 4. 비교 및 검증
      assertEquals(comment.toString(),expected.toString(),"Park의 모든 댓글을 출력!");
    }
    ...
    /* Case 3: null의 모든 댓글 조회 */
    {
      ...
      List<Comment> expected = Arrays.asList();
      // 4. 비교 및 검증
      assertEquals(comments.toString(),expected.toString(),"null을 닉네임으로 가지는 사람이 없음");
    }
